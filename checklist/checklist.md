...
Отзывы не должны требовать Email. Если Email используется для нотификаций о дискусии, об этом нужно предупреждать. Но нужно остаить возможность не заполнять поле.
