...
Изображение представляет собой собирательный образ магазина изделий ручной работы Handicraft. Для формирования образа можно  использовать как фотографии товаров из технических заданий к [шкатулкам](.\requirments_box.md), [ключницам](.\requirments_housekeepers.md), [браслетам](.\requirments_bracelet.md), так и [работы из архива](.\art.zip).
